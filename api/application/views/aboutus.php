				...
				<div class="table-responsiv">
				    <table class="table table-bordered" id="booklist" class="" cellspacing="0" width="100%">
					    ...
					    <tbody>
							<tr>
						    	<td>About us</td>
						        <td class="text-right"><a href="<?php echo base_url(); ?>/index.php/Aboutus/editAboutUs" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
							</tr>
					    </tbody>
				  	</table>
				</div>
