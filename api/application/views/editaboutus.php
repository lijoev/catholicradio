				...
				<div class="container-fluid">
					<div class="panel panel-default">
						<div class="panel-body">
			      			<form action="<?php echo base_url(); ?>/index.php/Aboutus/editAboutUs" enctype="multipart/form-data" method="post" name = "payment">
								
								<div class="form-group">
								    <label for="">About Us</label>
								    <input type="text" name="about" value="<?php echo $aboutus ?>" class="form-control" id="" placeholder="About Us">
								</div>
