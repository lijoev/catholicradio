...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="container-fluid" >
		...
		<div class="panel panel-default">
			<div class="pull-right"><a href="<?php echo base_url(); ?>/index.php/Holymass/addHolymass" data-toggle="tooltip" title="add" class="btn btn-primary"><i class="fa fa-plus"></i></a>
	...
	<div class="panel-body">
		<div class="row">
			<form action="<?php echo base_url(); ?>/index.php/Holymass/deleteHolymass" method="post" enctype="multipart/form-data" id="form-product">
				<div class="table-responsiv">
				    <table class="table table-bordered" id="booklist" class="" cellspacing="0" width="100%">
					    <thead>
						  <tr id = "table">
	 						<td style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
                              <td>Holy Mass Rite</td>
					          <td>File Name</td>
					          <td>Audio Url</td>
					    ...
					    <tbody>
							<tr>
						    	<?php $i = 1; ?>
						    	<?php foreach ($holymass_audios as  $holymass_audio) { ?>
						    	
						        <td class="text-center"><?php if (isset($selected) && in_array($holymass_audio['id'], $selected)) { ?>
				                    <input type="checkbox" name="selected[]" value="<?php echo $holymass_audio['id']; ?>" checked="checked" />
				                    <?php } else { ?>
				                    <input type="checkbox" name="selected[]" value="<?php echo $holymass_audio['id']; ?>" />
				                    <?php } ?>
			                    </td>
						        
                                <td><?php echo $holymass_audio['rite'] ?></td>
						        <td><?php echo $holymass_audio['file_name'] ?></td>
								<td><?php echo $holymass_audio['url'] ; ?></td>
