...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="container-fluid" >
		...
		<div class="panel panel-default">
			<div class="pull-right"><a href="<?php echo base_url(); ?>/index.php/Novena/addNovena" data-toggle="tooltip" title="add" class="btn btn-primary"><i class="fa fa-plus"></i></a>
	...
	<div class="panel-body">
		<div class="row">
			<form action="<?php echo base_url(); ?>/index.php/Novena/deleteNovena" method="post" enctype="multipart/form-data" id="form-product">
				<div class="table-responsiv">
				    <table class="table table-bordered" id="booklist" class="" cellspacing="0" width="100%">
					    ...
					    <tbody>
							<tr>
						    	<?php $i = 1; ?>
						    	<?php foreach ($novena_audios as  $novena_audio) { ?>
						    	
						        <td class="text-center"><?php if (isset($selected) && in_array($novena_audio['id'], $selected)) { ?>
				                    <input type="checkbox" name="selected[]" value="<?php echo $novena_audio['id']; ?>" checked="checked" />
				                    <?php } else { ?>
				                    <input type="checkbox" name="selected[]" value="<?php echo $novena_audio['id']; ?>" />
				                    <?php } ?>
			                    </td>
                                <td><?php echo $novena_audio['saint'] ?></td>
								<td><?php echo $novena_audio['url'] ; ?></td>
